...
/* harmony import */ var _modules_Agencias__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Agencias */ "./src/modules/Agencias.js");
/* harmony import */ var _modules_Agencias__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_Agencias__WEBPACK_IMPORTED_MODULE_3__);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Obtener continentes
  fetch('/wp-json/custom/v1/continentes').then(response => response.json()).then(data => {
  ...
  continentesSelect.addEventListener('change', function () {
    ...
    galeria.innerHTML = '';
    if (continenteId) {
      fetch(`/wp-json/custom/v1/paises/${continenteId}`).then(response => response.json()).then(data => {
        if (!Array.isArray(data) || data.length === 0) {
  ...
  paisesSelect.addEventListener('change', function () {
    ...
    galeria.innerHTML = '';
    if (paisId) {
      fetch(`/wp-json/custom/v1/ciudades/${paisId}`).then(response => response.json()).then(data => {
        if (!Array.isArray(data) || data.length === 0) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkoslo_theme"] = globalThis["webpackChunkoslo_theme"] || [];
